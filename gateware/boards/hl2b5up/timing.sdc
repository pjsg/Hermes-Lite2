...
create_generated_clock -name clock_ethrxintfast -source [get_ports {phy_rx_clk}] {hermeslite_core:hermeslite_core_i|clock_ethrxint}
create_generated_clock -name clock_ethrxintslow -source [get_ports {phy_rx_clk}] {hermeslite_core:hermeslite_core_i|clock_ethrxint} -divide_by 10 -add
...
#set_false_path -from {hermeslite_core_i|ethtxint_clkmux_i|auto_generated|ena_reg}
#set_false_path -from {hermeslite_core_i|ethtxext_clkmux_i|auto_generated|ena_reg}
...
set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|arp:arp_inst|tx_byte_no[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]}] -setup -start 2
set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|arp:arp_inst|tx_byte_no[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]}] -hold -start 1

#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|Tx_send:tx_send_inst|udp_tx_length[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -setup -start 3
#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|Tx_send:tx_send_inst|udp_tx_length[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -hold -start 2
...
#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|icmp:icmp_inst|destination_ip[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -setup -start 3
#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|icmp:icmp_inst|destination_ip[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -hold -start 2

#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|dhcp:dhcp_inst|destination_ip[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -setup -start 3
#set_multicycle_path -from [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|dhcp:dhcp_inst|destination_ip[*]}] -to [get_keepers {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]}] -hold -start 2

#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|icmp:icmp_inst|icmp_fifo:icmp_fifo_inst|*} -to {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]} -setup -start 2
#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|icmp:icmp_inst|icmp_fifo:icmp_fifo_inst|*} -to {hermeslite_core:hermeslite_core_i|network:network_inst|ip_send:ip_send_inst|shift_reg[*]} -hold -start 1

#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|udp_send:udp_send_inst|byte_no[*]} -to {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]} -setup -start 2
#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|udp_send:udp_send_inst|byte_no[*]} -to {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]} -hold -start 1

#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|tx_protocol*} -to {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]} -setup -start 2
#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|tx_protocol*} -to {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]} -hold -start 1

#set_multicycle_path -from {hermeslite_core:hermeslite_core_i|network:network_inst|icmp:icmp_inst|sending*} -to {hermeslite_core:hermeslite_core_i|network:network_inst|mac_send:mac_send_inst|shift_reg[*]} -setup -start 2
